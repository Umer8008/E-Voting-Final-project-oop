...
void LOCAL::increment_vote(string z)
{
...
void LOCAL::create_election(string a)
{
	...
	//other than those province candidates is in temp
...
void LOCAL::admin_view_result()
{
	...
	if (columns == 0)
		cout << "Not any Candidate in " << union_council << " ." << endl << endl;
	else
		cout << "\nTotal candidate = " << columns << endl << endl;
	y1.close();
}
